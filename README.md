# 🍊 Tangerine
A lightweight 2D rendering engine built in C++ using OpenGL. Tangerine provides a modular framework for creating real-time graphical applications with custom rendering systems, asset management, and low-level graphics abstractions.
